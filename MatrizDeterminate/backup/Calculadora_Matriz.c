...
void OpMatriz(){
	...
	system("cls");
	printf("Nesta operação as duas matrizes precisam ser de mesma ordem!\n");
...
long int  inversa(long int  m['a']['a']){
	...
	if(d==0){
		printf("\nA matriz nao tem inversa a determinante = %.0lf\n", det);
	}else{
